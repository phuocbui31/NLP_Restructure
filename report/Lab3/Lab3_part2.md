...
- **Source Code**:
  - [src/nlp_restructure/Lab3/src/representations/word_embedder.py](../../src/nlp_restructure/Lab3/src/representations/word_embedder.py): Class `WordEmbedder` để load và sử dụng pre-trained models.
- **Test Scripts**:
  - [test/Lab3/lab4_test.py](../../test/Lab3/lab4_test.py): Script kiểm thử `WordEmbedder` với GloVe.
  - [test/Lab3/lab4_embedding_training_demo.py](../../test/Lab3/lab4_embedding_training_demo.py): Demo huấn luyện Word2Vec với Gensim trên dữ liệu UD English.
  - [test/Lab3/lab4_spark_word2vec_demo.py](../../test/Lab3/lab4_spark_word2vec_demo.py): Demo huấn luyện Word2Vec với Spark MLlib trên dữ liệu C4.
- **Data**:
  - [data/UD_English-EWT](../../data/UD_English-EWT/README.md): Dữ liệu huấn luyện nhỏ (Universal Dependencies) cho custom Gensim model.
  - [data/c4-train.00000-of-01024-30K.json](../../data/c4-train.00000-of-01024-30K.json.gz): Dataset lớn (C4 Common Crawl sample) cho Spark training.
- **Results**:
  - [results/lab4_test_output.txt](../../src/nlp_restructure/Lab3/results/lab4_test_output.txt)
  - [results/lab4_training_demo_output.txt](../../src/nlp_restructure/Lab3/results/lab4_training_demo_output.txt)
  - [results/lab4_spark_word2vec_output.txt](../../src/nlp_restructure/Lab3/results/lab4_spark_word2vec_output.txt)
...
#### Code triển khai
```python
# Từ test/Lab3/lab4_embedding_training_demo.py
model = Word2Vec(
    sentences=sentences,
    vector_size=50,
    window=5,
...
#### Code triển khai
```python
# Từ test/Lab3/lab4_spark_word2vec_demo.py
word2vec = Word2Vec(
    inputCol="words",
    outputCol="features",
