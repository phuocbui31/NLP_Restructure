...
- Mã nguồn chính:
  - [spark_labs/src/main/scala/...](../../src/nlp_restructure/Lab2/spark_labs/src/main/scala/com/phuocbui/spark/Lab17_NLPPipeline.scala) chứa lớp chính `com.phuocbui.spark.Lab17_NLPPipeline`.
  - [spark_labs/build.sbt](../../src/nlp_restructure/Lab2/spark_labs/build.sbt) nằm ở `spark_labs`.
- Dữ liệu:
  - C4 Common Crawl dataset (30K records).
  - Vị trí lưu trữ: [data/c4-train.00000-of-01024-30K.json.gz](../../data/c4-train.00000-of-01024-30K.json.gz) (Không đẩy lên github). Dưới đây là mô tả dữ liệu:
...
- File log và kết quả:
  - Metrics: [lab17_metrics.log](../../src/nlp_restructure/Lab2/spark_labs/log/lab17_metrics.log).
  - Results: [lab17_pipeline_output.txt](../../src/nlp_restructure/Lab2/spark_labs/results/lab17_pipeline_output.txt)
...
Tệp liên quan nhanh:
- Code chính: [spark_labs/src/main/scala/com/phuocbui/spark/Lab17_NLPPipeline.scala](../../src/nlp_restructure/Lab2/spark_labs/src/main/scala/com/phuocbui/spark/Lab17_NLPPipeline.scala)
- Build: [spark_labs/build.sbt](../../src/nlp_restructure/Lab2/spark_labs/build.sbt)
- Dữ liệu mẫu: [data/c4-train.00000-of-01024-30K.json.gz](../../data/c4-train.00000-of-01024-30K.json.gz)
- Metrics log: [spark_labs/log/lab17_metrics.log](../../src/nlp_restructure/Lab2/spark_labs/log/lab17_metrics.log)
- Results: [spark_labs/results/lab17_pipeline_output.txt](../../src/nlp_restructure/Lab2/spark_labs/results/lab17_pipeline_output.txt)
